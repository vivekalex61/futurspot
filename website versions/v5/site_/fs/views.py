...
class IndexView(generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['Post'] = [p for p in Post.objects.all() if p.alt_text == "Innovations"][:5]
        ...
        context["total_post"]=sorted(chain(Post.objects.all(),Gallery.objects.all(), Event.objects.all()),key=attrgetter('created_on'), reverse=True)
