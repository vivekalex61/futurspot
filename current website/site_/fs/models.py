...
class Post(models.Model):
    ...
    meta_dec=models.CharField(max_length=155)
    ...
    dimage2= models.ImageField(upload_to='images/%Y/%m/%d/2',blank=True)
    dimage3= models.ImageField(upload_to='images/%Y/%m/%d/3',blank=True)
    dimage4= models.ImageField(upload_to='images/%Y/%m/%d/4',blank=True)
    ...
    def save(self, force_insert=False, force_update=False):
        ...
        if self.dimage is not None:
                ...
                image = Image.open(self.dimage.path)
                image = image.resize((795,460), Image.ANTIALIAS)
                image.save(self.dimage.path)
